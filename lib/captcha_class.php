...
class Captcha{
   ...
   private static $letters = array("a", "b", "c", "d", "e", "f");
   ...
   public static function generate(){
      ...
      for($i = 0; $i < self::BG_LET_AMOUNT; $i++){
         ...
         imagettftext($src, $size, rand(0, 45), rand(self::WIDTH * 0.1, self::WIDTH * 0.9),
           rand(self::HEIGHT * 0.1, self::HEIGHT * 0.9), $color, self::FONT, $letter);
      }
      $code = "";
