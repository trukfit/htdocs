...
class JSValidator{
   ...
   public function password($f_equal = false, $min_len = true, $t_empty = false){
      ...
      else $this->message->get(ValidatePassword::CODE_EMPTY);
      if($f_equal){
         $cl->f_equal = $f_equal;
   ...
   public function avatar(){
      $cl = $this->getBase();
      $cl->t_empty = $this-$this->message->get("ERROR_AVATAR_EMPTY");
      return $cl;
   }

   public function captcha(){
      $cl = $this->getBase();
      $cl->t_empty = $this-$this->message->get("ERROR_CAPTCHA_EMPTY");
      return $cl;
   }
